...
public class GridSheetViewport extends JViewport {
  ...
  public void scrollRectToVisible(Rectangle contentRect) {
    ...
    if (view == null) {
      ...
      dx =
          isFrozenAreaSelectedX ? 0 : positionAdjustment(getWidth(), contentRect.width,
              contentRect.x, divisionPointX, frozenPointX);
      dy =
          isFrozenAreaSelectedY ? 0 : positionAdjustment(getHeight(), contentRect.height,
              contentRect.y, divisionPointY, frozenPointY);
