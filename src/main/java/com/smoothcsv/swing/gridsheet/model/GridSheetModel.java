    ...
    if (adjusting) {
      ...
      if (!dataUpdateListeners.isEmpty()) {
        GridSheetDataEvent e =
            new GridSheetDataEvent(this, firstRow, firstColumn, lastRow, lastColumn,
                structureChanged);
        for (Consumer<GridSheetDataEvent> l : dataUpdateListeners) {
          l.accept(e);
        }
    ...
    if (!structureChangelistenerList.isEmpty()) {
      GridSheetStructureEvent e =
          new GridSheetStructureEvent(this, GridSheetStructureEvent.INSERT_COLUMN, adjusting,
              index, columnsInserted.length, getRowCount(), getColumnCount());
    ...
    if (!structureChangelistenerList.isEmpty()) {
      GridSheetStructureEvent e =
          new GridSheetStructureEvent(this, GridSheetStructureEvent.REMOVE_COLUMN, adjusting,
              index, columnsRemoved.length, getRowCount(), getColumnCount());
      for (Consumer<GridSheetStructureEvent> l : structureChangelistenerList) {
        l.accept(e);
      }
    }
